...
class AAMoveOverEventMessageModel1 {
...
class AAChartView1 : WebView {
    interface AAChartViewCallBack {
        fun chartViewDidFinishLoad(aaChartView: AAChartView1)
    ...
    private fun loadLocalFilesAndDrawChart(aaOptions: AAOptions) {
        ...
        webViewClient = object : WebViewClient() {
            override fun onPageFinished(
                ...
                callBack?.chartViewDidFinishLoad(this@AAChartView1)
            }
        }
    }
